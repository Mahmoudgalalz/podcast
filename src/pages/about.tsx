...
export default function about(){
    return (
        ...
        <main className="flex flex-col justify-center items-center my-20">
            ...
            <p className="text-center text-xl my-20 mx-6 sm:mx-40">This is Mahmoud Galal aka KroKing, I created this podacast to share my story as a <span className="uppercase font-extrabold">Software Engineer</span> and share other Junior software engineers's stories,
                in a way to enrich the Arabic content about Tech, I'm trying to help Junior Software Engineers to be better in this field.
            </p>
